...
class Temperature:
    ...
    def _build_url(self):
        """Build the url string by adding the country and city"""
        url = self.base_url + self.country + "/" + self.city
        return url

    def _scrape(self):
        """Extracts a value as instructed by yml file and returns a dictionary"""
...
if __name__ == "__main__":
    temperature = Temperature(country="germany", city="berlin")
